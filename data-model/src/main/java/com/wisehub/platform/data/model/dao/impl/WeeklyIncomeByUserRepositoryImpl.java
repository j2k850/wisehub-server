...
@Repository
public class WeeklyIncomeByUserRepositoryImpl extends AbstractCrudRepository<WeeklyIncomeByUser, String> implements WeeklyIncomeByUserRepository {

	private static Logger logger = LoggerFactory.getLogger(WeeklyIncomeByUserRepositoryImpl.class.getName());

	private static final String TABLE_NAME = "weekly_income_by_user";
	...
	@Override
	public Class<WeeklyIncomeByUser> getEntityClass() {
		return WeeklyIncomeByUser.class;
	}
