...
public enum AccountStatus {
	...
	// LoggerFactory.getLogger(AccountStatus.class.getName());
	...
	private static final Function<AccountStatus, Integer> VALUE_FUNCTION = new Function<AccountStatus, Integer>() {
		@Override
	...
	private static final Map<Integer, AccountStatus> VALUE_LOOKUP = Maps
			.uniqueIndex(Arrays.asList(AccountStatus.class.getEnumConstants()), VALUE_FUNCTION);
}
