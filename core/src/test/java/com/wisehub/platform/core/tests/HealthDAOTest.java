...
import com.wisehub.platform.core.orm.dao.HealthDAO;
...
public class HealthDAOTest {
	private static abstract class Context {
		...
		public void setup() throws Exception {
			...
			// when(query.setString(Mockito.anyString(),
			// Mockito.anyString())).thenReturn(query);
	...
	public static class Checking_Health_When_Unhealthy extends Context {
		...
		public void itLogsTheError() throws Exception {
			...
			// verify(logger).log(Level.SEVERE, "Error connecting to the database",
			// exception);
		}
	}
	...
	public static class Checking_Health_When_Really_Weird extends Context {
		...
		public void itLogsTheError() throws Exception {
			...
			// verify(logger).severe("The database just returned fifty instead of
			// health-check. That's weird");
		}
	}
}
